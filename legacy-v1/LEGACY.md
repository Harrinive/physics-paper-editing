...
| **Scope overflow (>12 sentences)** | § Scope overflow below — route to the parent skill; do **not** read [cross-skill.md](../../physics-paper-editing-section/legacy-v1/cross-skill.md) |
| **Invoked from macro Stage D** | This file + [Invoked by section macro](#invoked-by-section-macro-optional) + parent [cross-skill.md](../../physics-paper-editing-section/legacy-v1/cross-skill.md) § Verifier model profile |
...
4. **Draft** — **`physics-paper-principles`**; no blocking source-audit phase. Named physical objects: [physical-lead.md](../../physics-paper-principles/legacy-v1/physical-lead.md).
...
3. Offer: attach [physics-paper-editing-section](../../physics-paper-editing-section/legacy-v1/LEGACY.md), **or** narrow to ≤12 sentences.

That is the **only** parent-skill awareness required on a standalone micro job. Do not read [cross-skill.md](../../physics-paper-editing-section/legacy-v1/cross-skill.md) unless you are routing overflow or were invoked from macro Stage D.
...
| Condition | Read |
|-----------|------|
| Always | [user-communication.md](user-communication.md), [coworker-loop.md](coworker-loop.md), [sentence.md](../../physics-paper-principles/legacy-v1/sentence.md), [severity.md](severity.md) |
| 2+ sentences | + [narrative.md](../../physics-paper-principles/legacy-v1/narrative.md) |
| Math, equations, logical argument, or a named-object definition | + [math.md](../../physics-paper-principles/legacy-v1/math.md); named objects: [physical-lead.md](../../physics-paper-principles/legacy-v1/physical-lead.md) |
...
**Canon (sibling skill)** — [physics-paper-principles/SKILL.md](../../physics-paper-principles/legacy-v1/LEGACY.md)
