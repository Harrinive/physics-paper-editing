...
|---|---|
| Low-risk strong edit | Direct path; no worker, state directory, snapshot, or legacy `OVERALL` |
| Low-risk economy edit | Scaffolded direct path; no exhaustive `N/A` list |
| Medium substantive edit | One holistic reviewer; math reviewer only when formal content changed |
| High-risk edit | Independent applicable reviews; adjudicator only on an actual conflict |
