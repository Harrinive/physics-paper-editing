...
The producer applies this rubric to the file. The synthesizer classifies severity and sets job-round `OVERALL`. The producer does **not** set `OVERALL`.
...
| `CONFLICTS` | At least one serious item reported to the user |
